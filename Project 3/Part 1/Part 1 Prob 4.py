...
alpha = 1.172e-5  # Thermal diffusivity of 1010 steel in m^2/s
dx = 0.05  # Spatial step size in meters
t_final = 10000.0  # Final time in seconds

# Create the diffusion solver object
solver = DiffusionSolver(L=L, alpha=alpha, dx=dx, T_cold=0.0, T_hot=50.0, T_init=20.0)

# Solve the diffusion equation
time, temperatures = solver.solve(t_final)
